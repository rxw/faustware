...
Which leaves compute -- and even here, the answer is unstable. The physical infrastructure -- the GPUs, the power contracts, the purpose-built data centers -- is genuinely hard to replicate, genuinely rivalrous, and genuinely upstream of everything the AI economy requires. Microsoft, Amazon, Google, and Nvidia are not glamorous answers, but they are sitting on the pipes through which all of this flows, and pipes, historically, are where the money is. The music industry owned distribution for decades. Then distribution became free, and the value didn't migrate to a new kind of distributor -- it evaporated into consumer surplus. If inference gets cheap enough, the same thing happens here. The pipes stop mattering. The value goes to the users, permanently and structurally, and there is very little anyone can do about it.

The labs built the discovery. Someone else will own the delivery. And if the delivery gets cheap enough, nobody will own anything at all. This is, depending on your position in the capital structure, either the best possible outcome for humanity or a very uncomfortable fact to have raised a Series B on.
